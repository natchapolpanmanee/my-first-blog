...
if (isset($_POST['submit'])) {
    ...
    // validate and validate input values
    if (!$title) {
    ...
    if (isset($_SESSION['edit-post'])) {
        ...
        // set is_featured if all posts to 0 if is_featured for this post is 1
        if ($is_featured == 1) {
        ...
        $query = "UPDATE posts SET title = '$title',body = '$body',thumbnail = '$thumbnail_to_insert',topic_id=$topic_id,is_featured = $is_featured WHERE id=$id LIMIT 1";
